...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cladd)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cladd
```

A live public deployment of this template is available at [https://cladd.templates.workers.dev](https://cladd.templates.workers.dev)
